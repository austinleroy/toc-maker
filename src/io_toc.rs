...
impl IoStoreTocHeaderCommon for IoStoreTocHeaderType3 {
    fn new(container_id: u64, entries: u32, compressed_blocks: u32, compression_block_size: u32, dir_index_size: u32) -> impl IoStoreTocHeaderCommon {
        Self {
            ...
            container_flags: io_container_flags::INDEXED,
...
impl IoChunkId {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoChunkId>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        for i in list {
...
impl IoOffsetAndLength {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoOffsetAndLength>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        for i in list {
            i.to_buffer::<W, E>(writer)?;
        }
        Ok(())
...
impl IoStoreTocCompressedBlockEntry {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoStoreTocCompressedBlockEntry>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        for i in list {
            i.to_buffer::<W, E>(writer)?;
        }
        Ok(())
...
impl IoDirectoryIndexEntry {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoDirectoryIndexEntry>, writer: &mut W) -> Result<(), Box<dyn Error>> {
...
impl IoFileIndexEntry {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoFileIndexEntry>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        writer.write_u32::<E>(list.len() as u32)?;
        for i in list {
            i.to_buffer::<W, E>(writer)?;
        }
...
impl IoStringPool {
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<String>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        writer.write_u32::<E>(list.len() as u32)?;
        for i in list {
...
impl IoStoreTocEntryMeta {
    ...
    pub fn list_to_buffer<W: Write, E: byteorder::ByteOrder>(list: &Vec<IoStoreTocEntryMeta>, writer: &mut W) -> Result<(), Box<dyn Error>> {
        for i in list {
            i.to_buffer::<W, E>(writer)?;
        }
        Ok(())
